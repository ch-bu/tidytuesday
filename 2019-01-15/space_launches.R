...
launches <- read_csv("launches.csv") %>%
  mutate(
    ...
    new_state_code = case_when(
      ...
      state_code == "F" ~  "France",
      state_code == "CN" ~ "China",
      state_code == "UK" ~ "United Kingdom",
      state_code == "KR" ~ "South Korea",
      state_code == "KP" ~ "North Korea",
      state_code == "J" ~ "Japan",
      state_code == "IR" ~ "Iran",
      state_code == "IN" ~ "India",
      state_code == "IL" ~ "Israel",
      state_code == "BR" ~ "Brazil",
      state_code == "I" ~ "Italy",
      TRUE ~ state_code
    )
  )
